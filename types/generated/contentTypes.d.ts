...
export interface ApiAccountRoleAccountRole extends Struct.CollectionTypeSchema {
  collectionName: 'account_roles';
  info: {
    description: '';
    displayName: 'account_role';
...
export interface ApiAccountUserAccountUser extends Struct.CollectionTypeSchema {
